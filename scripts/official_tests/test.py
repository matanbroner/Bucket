...
class TestHW3(unittest.TestCase):
    ...
    def gossip_helper(self, shard_count, nodes, ins):
        ...
        for i in range(keys):
            ...
            address, port = (
                ins[i % node_count]["address"],
                ins[i % node_count]["host_port"],
            )
    ...
    def view_change_helper(
        ...
        for i in range(keys):
            ...
            address, port = (
                old_ins[i % old_node_count]["address"],
                old_ins[i % old_node_count]["host_port"],
            )
        ...
        key_counts1 = self.view_change_response_helper(
            response, new_nodes, new_shard_count
        )
        print(key_counts1)
        ...
        for i in range(keys):
            ...
            value = "I do care %d" % i
            address, port = (
                new_ins[i % new_node_count]["address"],
                new_ins[i % new_node_count]["host_port"],
            )
            # get
            response = client.getKey(key, port)
            expected = getResponse_Success.copy()
    ...
    def test_view_change_1(self):
        ...
        new_shard_count, new_repl_factor, new_nodes = (
            2,
            2,
            [
                "10.10.0.2:13800",
    ...
    def test_view_change_2(self):
        old_shard_count, old_repl_factor, old_nodes = (
            1,
            2,
    ...
    def test_network_partition_1(self):
        ...
        ins = [
            ...
            {
                "subnet": "kv_subnet_partition",
                "host_port": 13801,
                "ip_address": "10.11.0.2",
                "address": "10.11.0.2:13800",
                "name": "node2",
                "view": view,
                "repl_factor": repl_factor,
            },
